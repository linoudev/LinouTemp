...
PIMAGE_NT_HEADERS64 mod::pe::GetNtHeaders(void* image_base) {
...
mod::pe::vec_relocs mod::pe::GetRelocs(void* image_base) {
...
mod::pe::vec_imports mod::pe::GetImports(void* image_base) {
	const PIMAGE_NT_HEADERS64 nt_headers = GetNtHeaders(image_base);
